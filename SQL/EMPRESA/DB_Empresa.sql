...
-- nessa parte, o Cpf_gerente não consegue referenciar o Cpf porque ele ainda não existe
INSERT INTO departamento (Dnome, Dnumero, Data_inicio_gerente) 
VALUES
('Pesquisa',6,"1966-05-22"),
('Admnistração',4,"1995-01-01"),
('Matriz',1,"1981-06-19");
-- populando a tabela dos funcionários (agora que é criado o Cpf)
...
-- adicionando o Cpf_gerente na tabela departamento
UPDATE departamento 
